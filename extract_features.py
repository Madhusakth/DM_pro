...
save_dir = 'C:/Users/caiju/Documents/ClassDocuments/EE380LDataMining/courseProject/images/preprocessed/'
...
def main(_):
  ...
  with tf.Session() as sess:
    ...
    for img in os.listdir(FLAGS.image_dir):
        if FLAGS.verbose > 0:
            counter += 1 
            if counter % FLAGS.verbose == 0:
                print("Processing images : %s" % str(img))
                np.save(FLAGS.save_dir+str(counter), np.array(final_array))
                final_array=[]

        temp_path = os.path.join(FLAGS.image_dir, '%s' % str(img))
    ...
    np.save(FLAGS.save_dir+str(counter), final_array)
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='C:/Users/caiju/Documents/ClassDocuments/EE380LDataMining/courseProject',
      help="""\
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='C:/Users/caiju/Documents/ClassDocuments/EE380LDataMining/courseProject/images/training',
